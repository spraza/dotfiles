# I use Balaji's .bashrc from Stanford's startup engineering course:
# http://startup.stanford.edu
# This file is a slightly modified version of his dot file which you can find at:
...
## 2.4) grep options
## Commented out since I was receiving:
